...
#define SCREEN_SIZE_X				 640		// 設定遊戲畫面的解析度為640x480
#define SCREEN_SIZE_Y				 480		// 註：若不使用標準的解析度，則不能切換到全螢幕
...
namespace game_framework {
	...
	public:
		...
		void  ShowBitmap(double factorX, double factorY);	// 將圖貼到螢幕 factor < 1時縮小，>1時放大。注意：需要VGA卡硬體的支援，否則會很慢
